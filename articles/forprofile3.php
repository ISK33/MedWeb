...
<body>
  ...
  height: 400px;
">
<h6 class="text-center" style="margin-top:60px;font-size:50px;font-family: sans-serif;font-style:italic;color:#8abdb6"> MedWeb's Articles & News</h6>
    </div>
  </div>
...
include('config.php');
      ...
      <div style="margin-top:70px;width:400px" class="col-lg-3">
        ...
        <div style="width:400px;margin-top:120px" class="list-group text-center" id="list-tab" role="tablist">
          <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">How to get rid of fats on the heart</a>
        ...
        <div>
          <div style="width:400px;margin-top:40px" class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">It is considered a mistake to use the term good fats and bad fats, according to Dr. Jessica Bennett, an American nutritionist, because of the person’s psychological condition, which leads them to continue eating fats whenever their use coincides with the word good, and it is better to use the term healthy fats and unhealthy or less healthy fats.
              </br></br>
              Heart fats are categorized as unhealthy fats that have the power to raise cholesterol and often end up with major arterial problems, strokes and heart attacks.</br></br>
              While there are healthy fats the body needs in order to aid in the growth of cells and organs, brain health, hormone production and a co-feeling of warmth.</div>
