...
<body>
      ...
      <div class="container-fluid p-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navmenu">
          <ul class="navbar-nav mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a href="see-the-question_doctor.php" role="button" class="nav-link font-family-Tajawal">Questions and Answers</a>
            </li>
            <li class="nav-item">
          ...
          <form class="d-flex ms-auto">
            ...
            <div class="dropdown d-profile">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                <li>
                  <a class="dropdown-item" href="../profile_doctor.html">My profile</a>
                </li>
  ...
  <!--breakcrump End-->
  <div class="container">
    <div class="row" style="margin-top: 52px; margin-bottom: 52px; margin-right:  5px;margin-left: 200px;width:40% auto">
      <div class="col-sm-12 col-lg-3" style="margin-left:5px; width:60% ">
        <?php

include('config.php');
        $query = "SELECT * FROM questions,medical_record,users  WHERE medical_record.user_id=questions.user_id AND users.user_id=questions.user_id AND answer IS NULL ORDER BY id  ASC";
   $resultm = mysqli_query($link, $query);
       if (isset($_GET['id'])) {
          ...
          $addans = "UPDATE  questions SET answer
            ...
            where id ='$_GET[id]';";
          $run = mysqli_query($link, $addans) or die($con->error);
          echo '<script type="text/javascript">
location.replace("doctors-answers.php");
			  </script>';
        ...
        ?>
          ...
          <br>
          <div class="row" style="margin-top: 50px;margin-right:  5px;margin-left: 10px;">
            <h6 style="font-size:18px; text-align:justify;margin-bottom:20px; "> <?php echo $row['title']; ?></h6>
            <hr>
            <h6 style="font-size:18px; text-align:justify;margin-bottom:20px; ">Classification :<?php echo $row['classification']; ?></h6>
            <hr>
            <h6 style="font-size:18px ; text-align:justify;margin-top:20px; margin-bottom:20px; "><?php echo $row['questions']; ?></h6>
            <hr>
            <div Class="a">
              <p style="color: darkgray; font-size:18px;"> The patient's medical record</p>
              <hr style="max-width:600px;">
              <div style=" margin-bottom:7px;">
                <p>Name: <?php echo $row['first_name'];
                          echo "   ";
              ...
              <form id="<?php echo $row['id']; ?>" onsubmit="return getId(this.id)">
                ...
                <textarea class="form-control" style="width: 100%; margin-top: 7px; background-color:rgb(256,256,256);font-size:18px;" id="answer1" name="answer1">
					       ...
					       <input type="hidden" name="id" class="the_id" value="<?php echo $row['id'];?>">

                <input class="btn btn-primary border-white" type="submit" value="Answer" name="answer" id="<?php echo $row['id']; ?>" style="margin-top: 10px;margin-bottom: 5px; background-color: #1bac8fbe	;color: rgb(11,11,11);font-size: 18px;"></input>
                <hr>
              </form>
            </div>
          <?php
