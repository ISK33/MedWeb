      ...
      <div class="container-fluid p-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navmenu">
          <ul class="navbar-nav mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a href="send-your-question.html" role="button" class="nav-link font-family-Tajawal">Qustions </a>
            </li>
            <li class="nav-item">
  ...
  <div style="margin-top: 10px;margin-right: -47px;margin-left: -48px;padding: 33px; ">
    <div class="container" style="background-color:#d4e2ee;">
      <div class="row border p-3 pb-3">
        <div class="col">
          <p>
            Would you like to speak to a text doctor or a phone?
            You can get a free consultation for the first time when you sign up.Please go and register now
            <br>
            <a class="btn btn-primary" type="button" style=" width: 100%;background-color: rgb(146,205,218);color: rgb(7,6,6);margin-top:35px;" href="send-your-question.html">Ask a doctor for free</a>
          </p>
        </div>
      </div>
    </div>
